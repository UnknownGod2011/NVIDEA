...
public sealed class WorkerResultSigningDeploymentPreflightTests
{
    ...
    public void Validate_RequiresDedicatedWorkerResultSigningSecretReference()
    {
        ...
        var error = Assert.Throws<InvalidOperationException>(() => NebiusResearchDeploymentPreflight.ValidateWorkerResultSigningSecretProvisioning(valid with { SecretEnvironmentVariables = secrets }));
    ...
    public void Validate_RejectsWorkerResultSigningPrivateKeyInPlaintextConfiguration()
    {
        ...
        var error = Assert.Throws<InvalidOperationException>(() => NebiusResearchDeploymentPreflight.ValidateWorkerResultSigningSecretProvisioning(valid with { EnvironmentVariables = environment }));
    ...
    {
        NebiusResearchDeploymentPreflight.ValidateWorkerResultSigningSecretProvisioning(CreateValidOptions());
    }
    ...
    private static NebiusResearchDispatchOptions CreateValidOptions()
    {
        ...
        return new NebiusResearchDispatchOptions(
            ...
            ContainerCommand: "dotnet", Platform: "cpu-d3", Preset: "1vcpu-4gb", Timeout: "3600s", SubnetId: "subnet-test",
            ...
            SecretEnvironmentVariables: new Dictionary<string, NebiusMysteryBoxSecretRef>(StringComparer.Ordinal)
            {
                ...
                [NebiusResearchDeploymentPreflight.WorkerResultSigningPrivateKeyEnvironmentVariable] = new(SecretId: "mbsec-worker-result-signing", VersionId: "mbsecver-worker-result-signing-v1")
            },
            Volumes: new[] { new NebiusServerlessVolumeMount("bucket", "/mnt/nvidea-research", "READ_WRITE") });
    }
}
